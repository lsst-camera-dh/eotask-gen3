...
from .eoDarkPixelData import EoDarkPixelData
...
class EoDarkPixelTaskConfig(EoAmpRunCalibTaskConfig,
    ...
    def setDefaults(self):
        self.connections.output = "DarkPixel"
...
class EoDarkPixelTask(EoAmpRunCalibTask):
    ...
    def run(self, stackedCalExp, **kwargs):
        ...
        nDarkPixel, nBrightColumn, fpSet = self.findDarkPixels(stackedCalExp, amp)
    ...
    def makeOutputData(self, nAmps, **kwargs):
        return EoDarkPixelData(nAmps=nAmps)
